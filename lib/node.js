...
var INSTANCE_NAME = process.env.INSTANCE_NAME|| 'Seyuf_madalien_debian';
...
function Node ()
{
	this.info = {
		...
		contact: (process.env.CONTACT_DETAILS || "seyuf@hotmail.com"),
		coinbase: null,
		node: null,
		net: null,
		protocol: null,
...
Node.prototype.startSocketConnection = function()
{
	if( !this._socket )
	{
		...
		socket = new Socket( process.env.WS_SERVER || 'wss://stats.ethdev.com' );
